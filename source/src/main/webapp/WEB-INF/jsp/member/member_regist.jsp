		...
		<c:choose>
			...
			<c:otherwise>
				...
				<form method="post"
					...
					<div>
						<label for="login-id">ID（必須）</label> <input type="text"
					...
					<div>
						<label for="user-name">氏名（必須）</label> <input type="text"
					...
					<fieldset>
						...
						<label> <input type="radio" name="role" value="0"
							${selectedRole == '0' ? 'checked' : ''}> 一般
						</label> <label> <input type="radio" name="role" value="1"
							${selectedRole == '1' ? 'checked' : ''}> 管理者
						</label>
					</fieldset>
