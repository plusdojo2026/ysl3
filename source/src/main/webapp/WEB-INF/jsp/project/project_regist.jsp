            ...
            <form class="management-form-card" method="POST" action="<c:url value='/Controller'/>">
                ...
                <div class="management-form-grid">
                    ...
                    <div class="management-field">
                        ...
                        <input class="management-input" type="text" id="project-code" name="project-code" maxlength="20" required>
                    </div>
                    <!-- 案件名 -->
                    <div class="management-field">
                        ...
                        <input class="management-input" type="text" id="project-name" name="project-name" maxlength="100" required>
                    </div>
                    <!-- 顧客名 -->
                    <div class="management-field">
                        ...
                        <input class="management-input" type="text" id="customer" name="customer" maxlength="50" required>
                    </div>
                    <!-- PM -->
                    <div class="management-field">
                    ...
                    <div class="management-field management-field-wide">
                        ...
                        <div class="management-date-period">
                            <input class="management-input" type="date" name="project-start-date" required>
                            <span class="management-date-separator">ー</span>
                            <input class="management-input" type="date" name="project-end-date">
                        </div>
                    </div>
                    <!-- 見積工数 -->
                    <div class="management-field">
                        ...
                        <input class="management-input" type="number" id="project-estimated-works" name="project-estimated-works" min="0.5" step="0.5" required>
                    </div>
                    <!-- 期限 -->
                    <div class="management-field">
                        ...
                        <input class="management-input" type="date" id="project-limit" name="project-limit" required>
                    </div>
                    <!-- 案件概要 -->
                    <div class="management-field management-field-wide">
                        ...
                        <input class="management-input" type="text" id="project-explain" name="project-explain" maxlength="2000">
                    </div>
                </div>
                <!-- 登録ボタン -->
                <div class="management-btn-area">
                    <button class="management-submit-btn" type="submit" name="btn-id" value="登録">
                        登録
                    </button>
                </div>
            </form>
